    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="bg-white rounded-2xl shadow-lg p-8">
          ...
          <p className="text-gray-600 mb-8">List your item and start receiving bids from our community.</p>
          ...
          {showSuccess && (
            <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
              <div className="flex items-center space-x-2 text-green-700">
                ...
                <span className="font-medium">Auction created successfully! Redirecting...</span>
              </div>
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-4">Or Upload Images (Up to 4 images)</label>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <select value={formData.category} onChange={(e) => setFormData(prev => ({ ...prev, category: e.target.value }))} className="w-full border border-gray-300 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent" required>
            ...
            <div className="flex justify-end space-x-4 pt-6 border-t border-gray-200">
              <button type="button" onClick={() => navigate('/')} className="px-6 py-3 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors">Cancel</button>
              <button type="submit" className="bg-gradient-to-r from-purple-600 to-blue-500 hover:from-purple-700 hover:to-blue-600 text-white px-8 py-3 rounded-lg font-bold transition-all duration-200 transform hover:scale-105 shadow-lg">Create Auction</button>
            </div>
          </form>
        </div>
      </div>
